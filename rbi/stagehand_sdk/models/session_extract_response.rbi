  ...
  module Models
    class SessionExtractResponse < StagehandSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            StagehandSDK::Models::SessionExtractResponse,
            StagehandSDK::Internal::AnyHash
          )
        end

      sig { returns(StagehandSDK::Models::SessionExtractResponse::Data) }
      attr_reader :data

      sig do
        params(
          data: StagehandSDK::Models::SessionExtractResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < StagehandSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              StagehandSDK::Models::SessionExtractResponse::Data,
              StagehandSDK::Internal::AnyHash
            )
          end
