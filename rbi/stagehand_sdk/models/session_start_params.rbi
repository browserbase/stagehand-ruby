...
module StagehandSDK
  module Models
    class SessionStartParams < StagehandSDK::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(StagehandSDK::SessionStartParams::Browser)) }
      attr_reader :browser

      sig do
        params(browser: StagehandSDK::SessionStartParams::Browser::OrHash).void
      end
      attr_writer :browser
      ...
      sig do
        returns(T.nilable(StagehandSDK::SessionStartParams::Verbose::OrFloat))
      end
      attr_reader :verbose

      sig do
        params(verbose: StagehandSDK::SessionStartParams::Verbose::OrFloat).void
      end
      attr_writer :verbose
      ...
      sig do
        returns(
          T.nilable(StagehandSDK::SessionStartParams::XStreamResponse::OrSymbol)
        )
      end
        ...
        override.returns(
          {
            model_name: String,
            act_timeout_ms: Float,
            browser: StagehandSDK::SessionStartParams::Browser,
            browserbase_session_create_params:
              StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams,
            browserbase_session_id: String,
            dom_settle_timeout_ms: Float,
      ...
      class Browser < StagehandSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              StagehandSDK::SessionStartParams::Browser,
              StagehandSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(StagehandSDK::SessionStartParams::Browser::LaunchOptions)
          )
        end
        ...
        sig do
          params(
            launch_options:
              StagehandSDK::SessionStartParams::Browser::LaunchOptions::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(StagehandSDK::SessionStartParams::Browser::Type::OrSymbol)
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type: StagehandSDK::SessionStartParams::Browser::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        class LaunchOptions < StagehandSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                StagehandSDK::SessionStartParams::Browser::LaunchOptions::IgnoreDefaultArgs::Variants
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                StagehandSDK::SessionStartParams::Browser::LaunchOptions::Proxy
              )
            )
          end
          attr_reader :proxy
          ...
          sig do
            params(
              proxy:
                StagehandSDK::SessionStartParams::Browser::LaunchOptions::Proxy::OrHash
            ).void
          end
          attr_writer :proxy
          ...
          sig do
            returns(
              T.nilable(
                StagehandSDK::SessionStartParams::Browser::LaunchOptions::Viewport
              )
            )
          end
          ...
          sig do
            params(
              viewport:
                StagehandSDK::SessionStartParams::Browser::LaunchOptions::Viewport::OrHash
            ).void
          end
          ...
          module IgnoreDefaultArgs
            ...
            StringArray =
              T.let(
                StagehandSDK::Internal::Type::ArrayOf[String],
                StagehandSDK::Internal::Type::Converter
              )
          end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, StagehandSDK::SessionStartParams::Browser::Type)
            end
          ...
          LOCAL =
            T.let(
              :local,
              StagehandSDK::SessionStartParams::Browser::Type::TaggedSymbol
            )
          BROWSERBASE =
            T.let(
              :browserbase,
      ...
      class BrowserbaseSessionCreateParams < StagehandSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            browser_settings:
              StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::Proxies::Variants
            )
          )
        end
        attr_reader :proxies
        ...
        sig do
          returns(
            T.nilable(
              StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::Region::OrSymbol
            )
          )
        end
        attr_reader :region
        ...
        class BrowserSettings < StagehandSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              context:
                StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Context::OrHash
            ).void
          end
          attr_writer :context
          ...
          sig do
            params(
              fingerprint:
                StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::OrHash
            ).void
          end
          ...
          sig do
            params(
              viewport:
                StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Viewport::OrHash
            ).void
          end
          attr_writer :viewport
          ...
          class Fingerprint < StagehandSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::Browser::OrSymbol
                  ]
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::Device::OrSymbol
                  ]
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::HTTPVersion::OrSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::OperatingSystem::OrSymbol
                  ]
                )
              )
            end
            ...
            sig do
              params(
                screen:
                  StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::Screen::OrHash
              ).void
            end
            attr_writer :screen
            ...
            module Browser
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::Browser
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              CHROME =
                T.let(
                  :chrome,
                  StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::Browser::TaggedSymbol
                )
              EDGE =
                T.let(
                  :edge,
            ...
            module Device
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::Device
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              DESKTOP =
                T.let(
                  :desktop,
                  StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::Device::TaggedSymbol
                )
              MOBILE =
                T.let(
                  :mobile,
            ...
            module HTTPVersion
              ...
              HTTP_VERSION_1 =
                T.let(
                  :"1",
                  StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::HTTPVersion::TaggedSymbol
                )
              HTTP_VERSION_2 =
                T.let(
                  :"2",
            ...
            module OperatingSystem
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::OperatingSystem
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              ANDROID =
                T.let(
                  :android,
                  StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::BrowserSettings::Fingerprint::OperatingSystem::TaggedSymbol
                )
              IOS =
                T.let(
                  :ios,
          ...
          Variants =
            T.type_alias do
              T.any(
                T::Boolean,
                T::Array[
                  StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::Proxies::ProxyConfigList::Variants
                ]
              )
            end
          ...
          module ProxyConfigList
            ...
            class Browserbase < StagehandSDK::Internal::Type::BaseModel
              ...
              sig do
                params(
                  geolocation:
                    StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::Proxies::ProxyConfigList::Browserbase::Geolocation::OrHash
                ).void
              end
        ...
        module Region
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::Region
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          US_WEST_2 =
            T.let(
              :"us-west-2",
              StagehandSDK::SessionStartParams::BrowserbaseSessionCreateParams::Region::TaggedSymbol
            )
          US_EAST_1 =
            T.let(
              :"us-east-1",
      ...
      module Verbose
        ...
        TaggedFloat =
          T.type_alias do
            T.all(Float, StagehandSDK::SessionStartParams::Verbose)
          end
        OrFloat = T.type_alias { Float }

        VERBOSE_0 =
          T.let(0, StagehandSDK::SessionStartParams::Verbose::TaggedFloat)
        VERBOSE_1 =
          T.let(1, StagehandSDK::SessionStartParams::Verbose::TaggedFloat)
        VERBOSE_2 =
          T.let(2, StagehandSDK::SessionStartParams::Verbose::TaggedFloat)

        sig do
          override.returns(
            T::Array[StagehandSDK::SessionStartParams::Verbose::TaggedFloat]
          )
        end
        def self.values
        end
      ...
      module XStreamResponse
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, StagehandSDK::SessionStartParams::XStreamResponse)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        TRUE =
          T.let(
            :true,
            StagehandSDK::SessionStartParams::XStreamResponse::TaggedSymbol
          )
        FALSE =
          T.let(
            :false,
