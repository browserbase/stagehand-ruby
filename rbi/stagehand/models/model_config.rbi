  ...
  module Models
    module ModelConfig
      ...
      Variants =
        T.type_alias do
          T.any(
            ...
            Stagehand::ModelConfig::AzureEntraModelConfigObject,
            Stagehand::ModelConfig::AzureAPIKeyModelConfigObject,
      ...
      class AzureEntraModelConfigObject < Stagehand::Internal::Type::BaseModel
        ...
        sig do
          returns(Stagehand::ModelConfig::AzureEntraModelConfigObject::Auth)
        end
        attr_reader :auth
        ...
        sig do
          params(
            auth:
              Stagehand::ModelConfig::AzureEntraModelConfigObject::Auth::OrHash
          ).void
        end
        attr_writer :auth
        ...
        sig do
          params(
            provider_options:
              Stagehand::ModelConfig::AzureEntraModelConfigObject::ProviderOptions::OrHash
          ).void
        end
        attr_writer :provider_options
        ...
        sig do
          override.returns(
            {
              auth: Stagehand::ModelConfig::AzureEntraModelConfigObject::Auth,
              model_name: String,
              provider: Symbol,
              provider_options:
                Stagehand::ModelConfig::AzureEntraModelConfigObject::ProviderOptions,
        ...
        class Auth < Stagehand::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stagehand::ModelConfig::AzureEntraModelConfigObject::Auth,
                Stagehand::Internal::AnyHash
              )
            end
          ...
          # Azure provider authentication configuration
          sig { params(token: String, type: Symbol).returns(T.attached_class) }
          def self.new(
            # Microsoft Entra ID bearer token for Azure OpenAI
            token:,
            # Use a Microsoft Entra ID bearer token for authentication
        ...
        class ProviderOptions < Stagehand::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Stagehand::ModelConfig::AzureEntraModelConfigObject::ProviderOptions::Azure
            )
          end
          attr_reader :azure
          ...
          sig do
            params(
              azure:
                Stagehand::ModelConfig::AzureEntraModelConfigObject::ProviderOptions::Azure::OrHash
            ).void
          end
          attr_writer :azure
      ...
      class AzureAPIKeyModelConfigObject < Stagehand::Internal::Type::BaseModel
        ...
        sig do
          params(
            provider_options:
              Stagehand::ModelConfig::AzureAPIKeyModelConfigObject::ProviderOptions::OrHash
          ).void
        end
        attr_writer :provider_options
        ...
        class ProviderOptions < Stagehand::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Stagehand::ModelConfig::AzureAPIKeyModelConfigObject::ProviderOptions::Azure
            )
          end
          attr_reader :azure
          ...
          sig do
            params(
              azure:
                Stagehand::ModelConfig::AzureAPIKeyModelConfigObject::ProviderOptions::Azure::OrHash
            ).void
          end
          attr_writer :azure
