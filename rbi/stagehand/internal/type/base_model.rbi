    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Stagehand::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Stagehand::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
                        Stagehand::Internal::Type::Converter::Input
                      )
                  }
                )
              ]
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Stagehand::Internal::Type::BaseModel::KnownField,
                  { type: Stagehand::Internal::Type::Converter::Input }
                )
              ]
            )
          end
            ...
            params(
              ...
              type_info:
                T.any(
                  ...
                  T.proc.returns(Stagehand::Internal::Type::Converter::Input),
                  Stagehand::Internal::Type::Converter::Input
                ),
              spec: Stagehand::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: Stagehand::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: Stagehand::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: Stagehand::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(Stagehand::Internal::AnyHash) }
        def to_h
        end
