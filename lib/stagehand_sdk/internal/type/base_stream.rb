  ...
  module Internal
    module Type
      ...
      module BaseStream
        ...
        #
        # @return [void]
        def close = StagehandSDK::Internal::Util.close_fused!(@iterator)
        ...
        # @api private
        #
        # @param model [Class, StagehandSDK::Internal::Type::Converter]
        ...
        # @return [String]
        def inspect
          model = StagehandSDK::Internal::Type::Converter.inspect(@model, depth: 1)
