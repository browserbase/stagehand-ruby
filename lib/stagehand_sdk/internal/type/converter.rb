    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { StagehandSDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { StagehandSDK::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            StagehandSDK::FilePart.new(value)
          in StagehandSDK::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in StagehandSDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [StagehandSDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: StagehandSDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in StagehandSDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in StagehandSDK::Internal::Type::Converter
              ...
              StagehandSDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(StagehandSDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
