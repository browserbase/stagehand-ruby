...
module StagehandSDK
  module Models
    ...
    class SessionObserveResponse < StagehandSDK::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [StagehandSDK::Models::SessionObserveResponse::Data]
      required :data, -> { StagehandSDK::Models::SessionObserveResponse::Data }
      ...
      #   @param data [StagehandSDK::Models::SessionObserveResponse::Data]
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see StagehandSDK::Models::SessionObserveResponse#data
      class Data < StagehandSDK::Internal::Type::BaseModel
        # @!attribute result
        #
        #   @return [Array<StagehandSDK::Models::SessionObserveResponse::Data::Result>]
        required :result,
                 -> { StagehandSDK::Internal::Type::ArrayOf[StagehandSDK::Models::SessionObserveResponse::Data::Result] }
        ...
        #   @param result [Array<StagehandSDK::Models::SessionObserveResponse::Data::Result>]
        #
