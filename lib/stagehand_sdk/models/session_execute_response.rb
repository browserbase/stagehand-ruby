...
module StagehandSDK
  module Models
    ...
    class SessionExecuteResponse < StagehandSDK::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [StagehandSDK::Models::SessionExecuteResponse::Data]
      required :data, -> { StagehandSDK::Models::SessionExecuteResponse::Data }
      ...
      #   @param data [StagehandSDK::Models::SessionExecuteResponse::Data]
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see StagehandSDK::Models::SessionExecuteResponse#data
      class Data < StagehandSDK::Internal::Type::BaseModel
        # @!attribute result
        #
        #   @return [StagehandSDK::Models::SessionExecuteResponse::Data::Result]
        required :result, -> { StagehandSDK::Models::SessionExecuteResponse::Data::Result }

        # @!method initialize(result:)
        #   @param result [StagehandSDK::Models::SessionExecuteResponse::Data::Result]

        # @see StagehandSDK::Models::SessionExecuteResponse::Data#result
        class Result < StagehandSDK::Internal::Type::BaseModel
          # @!attribute actions
          #
          #   @return [Array<StagehandSDK::Models::SessionExecuteResponse::Data::Result::Action>]
          required :actions,
                   -> { StagehandSDK::Internal::Type::ArrayOf[StagehandSDK::Models::SessionExecuteResponse::Data::Result::Action] }

          # @!attribute completed
          #   Whether the agent finished its task
          #
          #   @return [Boolean]
          required :completed, StagehandSDK::Internal::Type::Boolean
          ...
          optional :metadata, StagehandSDK::Internal::Type::HashOf[StagehandSDK::Internal::Type::Unknown]

          # @!attribute usage
          #
          #   @return [StagehandSDK::Models::SessionExecuteResponse::Data::Result::Usage, nil]
          optional :usage, -> { StagehandSDK::Models::SessionExecuteResponse::Data::Result::Usage }

          # @!method initialize(actions:, completed:, message:, success:, metadata: nil, usage: nil)
          #   @param actions [Array<StagehandSDK::Models::SessionExecuteResponse::Data::Result::Action>]
          #
          ...
          #
          #   @param usage [StagehandSDK::Models::SessionExecuteResponse::Data::Result::Usage]
          ...
          class Action < StagehandSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Boolean, nil]
            optional :task_completed, StagehandSDK::Internal::Type::Boolean, api_name: :taskCompleted
          ...
          # @see StagehandSDK::Models::SessionExecuteResponse::Data::Result#usage
