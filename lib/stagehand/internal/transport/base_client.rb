  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Stagehand::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Stagehand::Internal::Util.os,
            "x-stainless-package-version" => Stagehand::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Stagehand::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Stagehand::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Stagehand::Internal::Util.uri_origin(url) != Stagehand::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Stagehand::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Stagehand::Errors::APIConnectionError | (500..)
              Stagehand::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Stagehand::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Stagehand::Internal::Transport::PooledNetRequester.new
          @headers = Stagehand::Internal::Util.normalized_headers(
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{Stagehand::VERSION}"
        ...
        #
        #   @option req [Class<Stagehand::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Stagehand::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Stagehand::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Stagehand::Internal::Util.interpolate_path(uninterpolated_path)

          query = Stagehand::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = Stagehand::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        #
        # @raise [Stagehand::Errors::APIError]
        # @return [Array(Integer, Net::HTTPResponse, Enumerable<String>)]
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          url, headers, max_retries, timeout = request.fetch_values(:url, :headers, :max_retries, :timeout)
          input = {**request.except(:timeout), deadline: Stagehand::Internal::Util.monotonic_secs + timeout}
          ...
          headers = Stagehand::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Stagehand::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in Stagehand::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              Stagehand::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end

            raise Stagehand::Errors::APIStatusError.for(
              url: url,
              status: status,
              headers: headers,
              body: decoded,
          ...
          in (400..) | Stagehand::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param page [Class<Stagehand::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Stagehand::Internal::Type::BaseStream>, nil]
        #
        # @param model [Stagehand::Internal::Type::Converter, Class, nil]
        #
        # @param options [Stagehand::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Stagehand::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          Stagehand::RequestOptions.validate!(opts)
          ...
          headers = Stagehand::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = Stagehand::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,
          ...
          in {page: Class => page}
            ...
            Stagehand::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
