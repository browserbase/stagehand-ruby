    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Stagehand::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Stagehand::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Stagehand::FilePart.new(value)
          in Stagehand::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Stagehand::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Stagehand::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Stagehand::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Stagehand::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Stagehand::Internal::Type::Converter
              ...
              Stagehand::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Stagehand::Internal::Type::Converter, T::Class[T.anything]) }
        end
