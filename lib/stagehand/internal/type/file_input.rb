...
module Stagehand
  module Internal
    module Type
      ...
      # `Stagehand::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Stagehand::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Stagehand::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Stagehand::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Stagehand::FilePart.new(value, filename: "upload") : value
            in Stagehand::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
