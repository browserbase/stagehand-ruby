...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/stagehand_sdk/helpers/` and `examples/` directory.
...
require_relative "../lib/stagehand_sdk"
...
```ruby
gem "stagehand-sdk", git: "https://www.github.com/browserbase/stagehand-ruby"
```
...
```ruby
gem "stagehand-sdk", path: "<path-to-repo>"
```
