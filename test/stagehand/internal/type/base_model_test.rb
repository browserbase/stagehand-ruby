...
class Stagehand::Test::PrimitiveModelTest < Minitest::Test
  A = Stagehand::Internal::Type::ArrayOf[-> { Integer }]
  H = Stagehand::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Stagehand::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Stagehand::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Stagehand::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Stagehand::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Stagehand::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Stagehand::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Stagehand::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Stagehand::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Stagehand::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Stagehand::Internal::Type::Boolean, true] => true,
      [Stagehand::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Stagehand::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Stagehand::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Stagehand::Internal::Type::Converter.new_coerce_state
      Stagehand::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Stagehand::Internal::Type::Converter.dump(target, input, state: state)
...
class Stagehand::Test::EnumModelTest < Minitest::Test
  class E0
    include Stagehand::Internal::Type::Enum
...
class Stagehand::Test::CollectionModelTest < Minitest::Test
  A1 = Stagehand::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Stagehand::Internal::Type::HashOf[Integer]

  A2 = Stagehand::Internal::Type::ArrayOf[H1]
  H2 = Stagehand::Internal::Type::HashOf[-> { A1 }]

  A3 = Stagehand::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Stagehand::Internal::Type::HashOf[Integer, nil?: true]
...
class Stagehand::Test::BaseModelTest < Minitest::Test
  class M1 < Stagehand::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Stagehand::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Stagehand::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Stagehand::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Stagehand::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Stagehand::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Stagehand::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Stagehand::Errors::ConversionError => e
...
class Stagehand::Test::UnionTest < Minitest::Test
  class U0
    include Stagehand::Internal::Type::Union
  ...
  class M2 < Stagehand::Internal::Type::BaseModel
  ...
  class M4 < Stagehand::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Stagehand::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Stagehand::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Stagehand::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Stagehand::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Stagehand::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Stagehand::Internal::Type::Unknown, Stagehand::Internal::Type::Unknown] => true,
      [Stagehand::Internal::Type::Boolean, Stagehand::Internal::Type::Boolean] => true,
      [Stagehand::Internal::Type::Unknown, Stagehand::Internal::Type::Boolean] => false,
...
class Stagehand::Test::MetaInfoTest < Minitest::Test
  A1 = Stagehand::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Stagehand::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
