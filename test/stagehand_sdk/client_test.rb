...
class StagehandSDKTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    assert_raises(StagehandSDK::Errors::InternalServerError) do
  ...
  def test_client_redirect_307
    ...
    assert_raises(StagehandSDK::Errors::APIConnectionError) do
    ...
    assert_requested(:any, "http://localhost/redirected", times: StagehandSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: StagehandSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: StagehandSDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
