...
class StagehandSDK::Test::SingletonClient < StagehandSDK::Client
  include Singleton
  ...
  def initialize
    super(
      base_url: StagehandSDK::Test::SingletonClient::TEST_API_BASE_URL,
...
class StagehandSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @stagehand = StagehandSDK::Test::SingletonClient.instance
  end
