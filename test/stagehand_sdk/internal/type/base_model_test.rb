...
class StagehandSDK::Test::PrimitiveModelTest < Minitest::Test
  A = StagehandSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = StagehandSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < StagehandSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      StagehandSDK::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => StagehandSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [StagehandSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [StagehandSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [StagehandSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = StagehandSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        StagehandSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [StagehandSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [StagehandSDK::Internal::Type::Boolean, true] => true,
      [StagehandSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => StagehandSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        StagehandSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = StagehandSDK::Internal::Type::Converter.new_coerce_state
      StagehandSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        StagehandSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class StagehandSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include StagehandSDK::Internal::Type::Enum
...
class StagehandSDK::Test::CollectionModelTest < Minitest::Test
  A1 = StagehandSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = StagehandSDK::Internal::Type::HashOf[Integer]

  A2 = StagehandSDK::Internal::Type::ArrayOf[H1]
  H2 = StagehandSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = StagehandSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = StagehandSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class StagehandSDK::Test::BaseModelTest < Minitest::Test
  class M1 < StagehandSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < StagehandSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < StagehandSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, StagehandSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = StagehandSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = StagehandSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(StagehandSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue StagehandSDK::Errors::ConversionError => e
...
class StagehandSDK::Test::UnionTest < Minitest::Test
  class U0
    include StagehandSDK::Internal::Type::Union
  ...
  class M2 < StagehandSDK::Internal::Type::BaseModel
  ...
  class M4 < StagehandSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, StagehandSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < StagehandSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, StagehandSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class StagehandSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include StagehandSDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [StagehandSDK::Internal::Type::Unknown, StagehandSDK::Internal::Type::Unknown] => true,
      [StagehandSDK::Internal::Type::Boolean, StagehandSDK::Internal::Type::Boolean] => true,
      [StagehandSDK::Internal::Type::Unknown, StagehandSDK::Internal::Type::Boolean] => false,
...
class StagehandSDK::Test::MetaInfoTest < Minitest::Test
  A1 = StagehandSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = StagehandSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
